...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'alazhar_e808eb9879c473c92681_20240515063955_archive.zip';
        const ARCHIVE_SIZE       = '190494655';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'e808eb9-15063955';
        const SECONDARY_PACKAGE_HASH = 'de0b1de-15063955';
        const VERSION            = '1.5.9';
